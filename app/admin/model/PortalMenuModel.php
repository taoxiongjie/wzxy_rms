...
class PortalMenuModel extends Model
{
    ...
    public function adminMenu($parentId, $withSelf = false)
    {
        ...
        foreach ($result as $v) {
            ...
            if (preg_match('/^public_/', $action)) {
                ...
                if (cmf_auth_check(cmf_get_current_user_id(), $ruleName)) {
                    $array[] = $v;
                }
        ...
        if (count($data) > 0) {
            ...
            foreach ($data as $a) {
                ...
                if (strpos($app, 'plugin/') === 0) {
                    ...
                    //$url = "{$app}/{$controller}/{$action}{$params}";
